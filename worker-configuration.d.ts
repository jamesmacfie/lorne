/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 96155bdc8926abfda8c92d3bd0becfd5)
...
interface __BaseEnv_Env {
	...
	CREDENTIAL_RATE_LIMITER: RateLimit;
	CHAT_RATE_LIMITER: RateLimit;
	APP_ENV: "staging" | "production" | "development";
	BETTER_AUTH_URL: "https://staging.example.com" | "https://learn.example.com" | "http://localhost:3000";
	OPENAI_TEXT_MODEL: "gpt-5.6-sol";
	OPENAI_CHAT_MODEL: "gpt-5.6-luna";
	OPENAI_IMAGE_MODEL: "gpt-image-2";
	OPENAI_TEXT_REASONING_EFFORT: "low";
	DEFAULT_GENERATION_CARD_COUNT: "30";
	MAX_GENERATION_CARD_COUNT: "50";
	MAX_ACTIVE_GENERATION_JOBS: "2";
	CREDENTIAL_KEY_ACTIVE_VERSION: "1";
	LOG_LEVEL: "info";
	BETTER_AUTH_SECRET: string;
	OPENAI_CREDENTIAL_ENCRYPTION_KEY_V1: string;
	CARD_GENERATION_WORKFLOW: Workflow<Parameters<import("./src/server").CardGenerationWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BETTER_AUTH_URL" | "OPENAI_TEXT_MODEL" | "OPENAI_CHAT_MODEL" | "OPENAI_IMAGE_MODEL" | "OPENAI_TEXT_REASONING_EFFORT" | "DEFAULT_GENERATION_CARD_COUNT" | "MAX_GENERATION_CARD_COUNT" | "MAX_ACTIVE_GENERATION_JOBS" | "CREDENTIAL_KEY_ACTIVE_VERSION" | "LOG_LEVEL" | "BETTER_AUTH_SECRET" | "OPENAI_CREDENTIAL_ENCRYPTION_KEY_V1">> {}
}
